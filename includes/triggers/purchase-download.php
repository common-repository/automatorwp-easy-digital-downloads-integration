...
class AutomatorWP_Easy_Digital_Downloads_Purchase_Download extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User purchases a download', 'automatorwp-easy-digital-downloads-integration' ),
            'select_option'     => __( 'User purchases <strong>a download</strong>', 'automatorwp-easy-digital-downloads-integration' ),
            /* translators: %1$s: Post title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User purchases %1$s %2$s time(s)', 'automatorwp-easy-digital-downloads-integration' ), '{post}', '{times}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'User purchases %1$s', 'automatorwp-easy-digital-downloads-integration' ), '{post}' ),
            ...
            'options'           => array(
                'post' => automatorwp_utilities_post_option( array(
                    'name' => __( 'Download:', 'automatorwp-easy-digital-downloads-integration' ),
                    'option_none_label' => __( 'any download', 'automatorwp-easy-digital-downloads-integration' ),
                    'post_type' => 'download'
                ) ),
                'times' => automatorwp_utilities_times_option(),
            ),
            'tags' => array_merge(
                automatorwp_utilities_post_tags( __( 'Download', 'automatorwp-easy-digital-downloads-integration' ) ),
